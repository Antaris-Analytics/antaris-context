"""
Shared utilities for antaris-context.

Atomic file writes and common patterns used across multiple modules.
"""
...
def atomic_write_json(path: str, data: Any, indent: int = 2) -> None:
    ...
    # Guard against empty dirname (plain filenames)
    if dir_path:
    ...
    temp_path = None
    try:
        fd, temp_path = tempfile.mkstemp(dir=dir_path if dir_path else '.', suffix='.tmp')
